/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 501323a6af48e875da70c5fbc8f797cd)
...
interface __BaseEnv_Env {
	...
	ASSETS: Fetcher;
	CDO_API_BASE_URL: string;
	CDO_API_TOKEN: string;
	MAYA_API_BASE_URL: string;
	MAYA_API_EMAIL: string;
	MAYA_API_PASSWORD: string;
	BCRA_API_TOKEN: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CDO_API_BASE_URL" | "CDO_API_TOKEN" | "MAYA_API_BASE_URL" | "MAYA_API_EMAIL" | "MAYA_API_PASSWORD" | "BCRA_API_TOKEN" | "SESSION_SECRET" | "TURNSTILE_SECRET">> {}
}
